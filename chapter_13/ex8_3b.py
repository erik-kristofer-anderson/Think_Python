...
# now: try it with just christmas carol
# next: also import a christmas carol and
# generate text that is a hybrid of the two
...
def process_file_carol(filename):
    """proceses the file and returns a list,
    words_in_order, which is an ordered list
    of the words in the book
    """
...
words_in_order=(process_file_carol('carol.txt'))
